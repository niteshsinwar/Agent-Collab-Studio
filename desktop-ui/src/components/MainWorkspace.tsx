...
export const MainWorkspace: React.FC<MainWorkspaceProps> = ({
  ...
  const handleFileUpload = async () => {
    if (selectedFile && selectedAgent && onUploadDocument) {
      try {
        setIsUploading(true);
        // Pass current message as context for the document upload, like Gradio does
        await onUploadDocument(selectedAgent, selectedFile, message.trim());
        setSelectedFile(null);
        setMessage(''); // Clear message after upload like Gradio
          ...
          {agents.length === 0 ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      ...
                      className="px-3 py-1.5 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
              ...
              <div className="flex space-x-3">
                ...
                <button
                  type="submit"
                  disabled={!message.trim() || !selectedAgent || isTyping}
